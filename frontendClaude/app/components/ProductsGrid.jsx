...
export default function ProductsGrid() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const mergedQuery = [filters.query, filters.brand]
      ...
      const result = await fetchProducts({
        ...
        minimumTestScore:
          Number.isFinite(Number(filters.minimumTestScore))
            ? Number(filters.minimumTestScore)
            : undefined,
      });
      setData(result);
    } catch (err) {
  ...
  }, [load, filters.query, filters.brand]);
